...
Apply what you've learned so far to any endpoints you've created that take the user ID from the request body (`request.data['uid']` or `request.data['user id']`) and pass it through the header. Non-GET endpoints included.
