...
Since the JSON is generated by serializing an instance of the **`Animal`** class, that means you need to add a new property to your class. 
...
## Practice: Location - Employees and Animals
